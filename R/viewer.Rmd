...
vec <- c(
  rep(50, times = 10), rep(c(90, 10), times = 5),
  rep(100, times = 10), rep(107, times = 5), rep(NA, times = 5)
)
set.seed(4)
...
noise3 <- noise2
set.seed(100)
noise4 <- round(runif(10, min = -20, max = 20))

default_mat <- matrix(
  vec + c(noise1, noise2, noise3, noise4),
  nrow =  10,
  ncol = 4,
  dimnames = list(
