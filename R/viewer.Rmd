...
> In this next section we work with real data, in this case single-cell RNAseq data Alzheimer's Disease post-mortem brain tissue [Otero-Garcia, 2022, Neuron](https://doi.org/10.1016/j.neuron.2022.06.021).
...
Below are the top 5 gene sets sorted by greatest absolute difference between the modified and the original column.
...
> This section compliments the previous and shows the original gene expression values for the gene sets targeted.
