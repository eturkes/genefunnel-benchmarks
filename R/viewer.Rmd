...
tmp <- mat[order(counts(mat[ , 2]) / counts(mat[ , 1]), decreasing = FALSE), ]
rownames <- c(rownames, rownames(tmp)[1:10])
mat <- mat[rownames(mat) %in% rownames, ]
mat <- mat[match(rownames, rownames(mat)), ]
counts(mat) <- t(
  apply(
...
tmp <- mat[order(counts(mat[ , 3]) / counts(mat[ , 1]), decreasing = TRUE), ]
rownames <- rownames(tmp)[1:10]
tmp <- mat[order(counts(mat[ , 3]) / counts(mat[ , 1]), decreasing = FALSE), ]
rownames <- c(rownames, rownames(tmp)[1:10])
mat <- mat[rownames(mat) %in% rownames, ]
mat <- mat[match(rownames, rownames(mat)), ]
counts(mat) <- t(
